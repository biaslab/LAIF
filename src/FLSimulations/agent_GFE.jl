function constructAPrior()
    ...
    # A_0_4 = [10.0 eps; # Strong prior on informative location
    #          eps  10.0;
    #          eps  eps;
    #          eps  eps]
...
function initializeAgent(A_0, B, C, D_0)
    n_its = 10 # Iterations of variational algorithm
    D_s = deepcopy(D_0)
    A_s = deepcopy(A_0)
    function infer(t::Int64, a::Vector, o::Vector)
        ...
        for (i, j) in pols
            ...
            marginals = Dict{Symbol, ProbabilityDistribution}(
                :x_t_min => ProbabilityDistribution(Univariate, Categorical, p=D_s),
            ...
            G[i, j] = mean(Gis[5:n_its])./log(2) # Average to smooth fluctuations and convert to bits
